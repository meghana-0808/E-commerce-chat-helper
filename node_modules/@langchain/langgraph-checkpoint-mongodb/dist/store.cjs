...
function validateNamespace(namespace) {
	...
	for (const label of namespace) {
		if (typeof label !== "string") throw new _langchain_langgraph_checkpoint.InvalidNamespaceError(`Invalid namespace label '${label}' found in ${namespace}. Namespace labels must be strings, but got ${typeof label}.`);
...
*/
var MongoDBStore = class MongoDBStore extends _langchain_langgraph_checkpoint.BaseStore {
	client;
	db;
	collectionName;
	enableTimestamps;
